...
namespace Tweaks.Patches
{
    ...
    class BTSettlementMilitiaModelPatch
    {
        ...
        {
            if (TweaksMCMSettings.Instance is { } settings && settings.SettlementMilitiaBonusEnabled && !(settlement is null))
            {
        ...
        static bool Prepare() => TweaksMCMSettings.Instance is { } settings && settings.SettlementMilitiaBonusEnabled;
    }
}
