...
namespace Tweaks.Patches
{
    ...
    public class OnSessionLaunchedPatch
    {
        ...
        static bool Prepare() => TweaksMCMSettings.Instance is { } settings && settings.craftingUnlockAllParts;
    }
    ...
    public class GetMaxHeroCraftingStaminaPatch
    {
        ...
        {
            __result = TweaksMCMSettings.Instance is { } settings ? MathF.Round(settings.MaxCraftingStaminaMultiplier * __result) : __result;
        }

        static bool Prepare() => TweaksMCMSettings.Instance is { } settings && settings.CraftingStaminaTweakEnabled;
    }
    ...
    public class HourlyTickPatch
    {
        ...
        static bool Prefix(CraftingCampaignBehavior __instance)
        {
            ...
            foreach (Hero hero in records.Keys)
            {
                ...
                if (!(TweaksMCMSettings.Instance is null) && curCraftingStamina < __instance.GetMaxHeroCraftingStamina(hero))
                {
                    int staminaGainAmount = TweaksMCMSettings.Instance.CraftingStaminaGainAmount;
    ...
    class BTCraftingVMPatch
    {
        ...
        static bool Prepare() => TweaksMCMSettings.Instance is { } settings && settings.SmithingEnergyDisable;
    }
    ...
    class RefreshListPatch
    {
        ...
        static bool Prepare() => TweaksMCMSettings.Instance is { } settings && settings.SmeltingTweakEnabled;
    }
    ...
    public class GetSkillXpForRefiningPatch
    {
        ...
        static bool Prepare() => TweaksMCMSettings.Instance != null && TweaksMCMSettings.Instance.SmithingXpModifiers && TweaksMCMSettings.Instance.MCMSmithingHarmoneyPatches;
    }
    ...
    public class GetEnergyCostForRefiningPatch
    {
        ...
        static bool Prepare() => TweaksMCMSettings.Instance is { } settings && (settings.SmithingEnergyDisable || settings.CraftingStaminaTweakEnabled) && TweaksMCMSettings.Instance.MCMSmithingHarmoneyPatches;
    }
