...
namespace Tweaks.Patches
{
    ...
    class BTCalculateDailyFoodProductionAmountPatch
    {
        ...
        static bool Prepare() => TweaksMCMSettings.Instance is { } settings && (settings.ProductionTweakEnabled || settings.KingdomBalanceStrengthEnabled);
    }
    ...
    public class CalculateDailyProductionAmountPatch
    {
        ...
        static bool Prepare() => TweaksMCMSettings.Instance is { } settings && (settings.ProductionTweakEnabled || Statics._settings.WandererLocationDebug);
