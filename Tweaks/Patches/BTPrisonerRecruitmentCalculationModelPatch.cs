...
namespace Tweaks.Patches
{
    ...
    class BTPrisonerRecruitmentCalculationModelPatch
    {
        ...
        {
            if (TweaksMCMSettings.Instance is { } settings && settings.PrisonerConformityTweaksEnabled && !(party.LeaderHero is null))
            {
                float num;
        ...
        static bool Prepare() => TweaksMCMSettings.Instance is { } settings && settings.PrisonerConformityTweaksEnabled;
    }
}
