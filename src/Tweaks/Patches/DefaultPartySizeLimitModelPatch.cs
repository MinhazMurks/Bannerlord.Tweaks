...
namespace Tweaks.Patches
{
    ...
    public class DefaultPartySizeLimitModelPatch
    {
        ...
        static bool Prepare() => TweaksMCMSettings.Instance is { } settings && (settings.PartySizeTweakEnabled || settings.KingdomBalanceStrengthEnabled || settings.PlayerCaravanPartySizeTweakEnabled || settings.PartySizeMultipliersEnabled);
    }
    ...
    public class DefaultPrisonerSizeLimitModelPatch
    {
        ...
        static bool Prepare() => TweaksMCMSettings.Instance is { } settings && settings.PrisonerSizeTweakEnabled;
    }
}
