...
namespace Tweaks.Patches
{
    ...
    class KTBattleRewardsRenownGainPatch
    {
        ...
        static bool Prepare() => TweaksMCMSettings.Instance is { } settings && settings.MCMBattleRewardModifiers && settings.BattleRewardModifiersPatchOnly && settings.BattleRewardsRenownGainModifiers;
    }
    ...
    class KTBattleRewardsInfluenceGainPatch
    {
        ...
        static bool Prepare() => TweaksMCMSettings.Instance is { } settings && settings.MCMBattleRewardModifiers && settings.BattleRewardModifiersPatchOnly && settings.BattleRewardsInfluenceGainModifiers;
    }
    ...
    class KTBattleRewardsMoraleGainPatch
    {
        ...
        static bool Prepare() => TweaksMCMSettings.Instance is { } settings && settings.MCMBattleRewardModifiers && settings.BattleRewardModifiersPatchOnly && settings.BattleRewardsMoraleGainModifiers;
    }
    ...
    class KTBattleRewardsGoldLossPatch
    {
        ...
        static bool Prepare() => TweaksMCMSettings.Instance is { } settings && settings.MCMBattleRewardModifiers && settings.BattleRewardModifiersPatchOnly && settings.BattleRewardsGoldLossModifiers;
    }
    ...
    class KTBattleRewardsGainedRelationAmountPatch
    {
        ...
        static bool Prepare() => TweaksMCMSettings.Instance is { } settings && settings.MCMBattleRewardModifiers && settings.BattleRewardModifiersPatchOnly && settings.BattleRewardsRelationShipGainModifiers;
