namespace Tweaks.Settings
{
	...
	public class TweaksMCMSettings : AttributeGlobalSettings<TweaksMCMSettings>
	{
		...
		public string ModDisplayName => this.DisplayName;
		#endregion
		...
		public bool Debug
		{
			...
			set
			{
				if (this._Debug != value)
				{
					...
					if (value == false)
					{
						this.OnPropertyChanged(nameof(this.Debug));
					}
				}
			}
		}
		...
		*/
		...
		public override IEnumerable<ISettingsPreset> GetBuiltInPresets()
		{
			...
			yield return new MemorySettingsPreset(this.Id, "native all off", "Native All Off", () => new TweaksMCMSettings
			{
				//~ Age Tweaks
			...
			yield return new MemorySettingsPreset(this.Id, "native all on", "Native All On", () => new TweaksMCMSettings
			{
			...
			yield return new MemorySettingsPreset(this.Id, "Bannerlord Tweaks defaults 1.5.7.2", "Bannerlord Tweaks defaults 1.5.7.2", () => new TweaksMCMSettings
			{
		...
		public TweaksMCMSettings() => PropertyChanged += this.MCMSettings_PropertyChanged;

		private void MCMSettings_PropertyChanged(object? sender, System.ComponentModel.PropertyChangedEventArgs e)
		{
			if (e.PropertyName == nameof(this.Debug))
			{
				this.BattleRewardShowDebug = false;
				this.ArmyDebug = false;
				this.BattleRewardsDebug = false;
				this.ClanDebugging = false;
				this.ItemDebugMode = false;
				this.PregnancyDebug = false;
				this.XpModifiersDebug = false;
				this.TournamentDebug = false;
				this.PrisonersDebug = false;
				this.SettlementsDebug = false;
				this.WandererLocationDebug = false;
				this.PartySizeLimitsDebug = false;
				this.WorkshopsDebug = false;
				this.CraftingDebug = false;
				this.LearningDebug = false;
				this.BattleSizeDebug = false;
				this.CultureChangeDebug = false;
