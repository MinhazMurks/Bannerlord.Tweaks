...
{
    class TweaksPregnancyCampaignBehavior : PregnancyCampaignBehavior
    {
        ...
        {
            TweaksPregnancyCampaignBehavior.Pregnancy pregnancy = _heroPregnancies.Find((TweaksPregnancyCampaignBehavior.Pregnancy x) => x.Mother == hero);
            if (pregnancy == null)
            {
        ...
        {
            _heroPregnancies.Add(new TweaksPregnancyCampaignBehavior.Pregnancy(mother, mother.Spouse, CampaignTime.DaysFromNow(Campaign.Current.Models.PregnancyModel.PregnancyDurationInDays)));
        }
        ...
        {
            dataStore.SyncData<List<TweaksPregnancyCampaignBehavior.Pregnancy>>("_heroPregnancies", ref _heroPregnancies);
        }
        ...
        internal class Pregnancy
        {
            ...
            {
                ((TweaksPregnancyCampaignBehavior.Pregnancy)o).AutoGeneratedInstanceCollectObjects(collectedObjects);
            }
            ...
            {
                return ((TweaksPregnancyCampaignBehavior.Pregnancy)o).Mother;
            }
            ...
            {
                return ((TweaksPregnancyCampaignBehavior.Pregnancy)o).Father;
            }
            ...
            {
                return ((TweaksPregnancyCampaignBehavior.Pregnancy)o).DueDate;
            }
