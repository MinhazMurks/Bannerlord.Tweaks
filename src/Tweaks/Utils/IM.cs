namespace Tweaks.Utils
{
	...
	public static class IM
	{
		...
		public static void DisplayModLoadedMessage() => MessageInfo("Loaded");

		public static void DisplayModHarmonyErrorMessage() => MessageInfo("Will not function properly with out Harmony");


		//~ BT
		public static void ColorRedMessage(string message) => ShowMessage(message, Color.ConvertStringToColor("#FF0042FF"), logToFile);

		public static void ColorGreenMessage(string message) => ShowMessage(message, Color.ConvertStringToColor("#42FF00FF"), logToFile);

		public static void ColorBlueMessage(string message) => ShowMessage(message, Color.ConvertStringToColor("#0042FFFF"), logToFile);

		public static void ColorOrangeMessage(string message) => ShowMessage(message, Color.ConvertStringToColor("#00F16D26"), logToFile);
		...
		[Conditional("DEBUG")]
		public static void DebugMessage(string message) => MessageDebug(message);
		//~ BT
