namespace Tweaks.Models
{
	...
	internal class TweaksBanditDensityModel : DefaultBanditDensityModel
	{

		// Token: 0x17000B3A RID: 2874
		// (get) Token: 0x06002D7C RID: 11644 RVA: 0x000B59C9 File Offset: 0x000B3BC9
		public override int NumberOfMaximumLooterParties => 300;
		...
		public override int NumberOfMaximumTroopCountForFirstFightInHideout => MathF.Floor((float)(6.0 * (2.0 + Campaign.Current.PlayerProgress)));

		// Token: 0x17000B42 RID: 2882
		// (get) Token: 0x06002D84 RID: 11652 RVA: 0x000B59FC File Offset: 0x000B3BFC
		public override int NumberOfMaximumTroopCountForBossFightInHideout => MathF.Floor((float)(1.0 + (5.0 * (1.0 + Campaign.Current.PlayerProgress))));
