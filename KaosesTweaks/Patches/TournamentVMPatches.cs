...
namespace KaosesTweaks.Patches
{
    ...
    public class RefreshBetPropertiesPatch
    {
        ...
        {
            if (!(KaosesMCMSettings.Instance is { } settings)) return;
        ...
        static bool Prepare()
        {
            if (KaosesMCMSettings.Instance is { } settings && settings.TournamentMaxBetAmountTweakEnabled)
            {
                GetFieldInfo();
                return true;
            }
    ...
    public class RefreshValuesPatch
    {
        static void Postfix(TournamentVM __instance)
        {
            int num = KaosesMCMSettings.Instance is { } settings ? settings.TournamentMaxBetAmount : __instance.MaximumBetValue;
            if (Hero.MainHero.GetPerkValue(DefaultPerks.Roguery.DeepPockets))
            {
                num *= (int)DefaultPerks.Roguery.DeepPockets.PrimaryBonus;
            }
        ...
        static bool Prepare() => KaosesMCMSettings.Instance is { } settings && settings.TournamentMaxBetAmountTweakEnabled;
    }
