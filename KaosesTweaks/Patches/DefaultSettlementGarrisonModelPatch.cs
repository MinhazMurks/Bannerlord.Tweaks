...
namespace KaosesTweaks.Patches
{
    ...
    class DefaultSettlementGarrisonModelPatch
    {
        ...
        private static void Postfix(MobileParty mobileParty, Settlement settlement, ref int __result)
        {
            ...
            if (KaosesMCMSettings.Instance is { } settings && mobileParty.LeaderHero.Clan == Clan.PlayerClan)
            {
        ...
        static bool Prepare() => KaosesMCMSettings.Instance is { } settings && settings.DisableTroopDonationPatchEnabled;
    }
}
