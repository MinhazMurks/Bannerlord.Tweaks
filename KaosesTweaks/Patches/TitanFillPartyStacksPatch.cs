...
namespace KaosesTweaks.Patches
{
    ...
    public class TitanFillPartyStacksPatch
    {
        ...
        {
            if (KaosesMCMSettings.Instance is { } settings && settings.PartySizeMultipliersEnabled)
            {
        ...
        {
            if (KaosesMCMSettings.Instance is { } settings && settings.PlayerCaravanPartySizeTweakEnabled)
            {
        ...
        static bool Prepare() => KaosesMCMSettings.Instance is { } settings && (settings.PartySizeMultipliersEnabled || settings.PlayerCaravanPartySizeTweakEnabled);
    }
}
