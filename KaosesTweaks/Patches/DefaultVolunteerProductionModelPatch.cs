...
namespace KaosesTweaks.Patches
{
    ...
    class DefaultVolunteerProductionModelPatch
    {
        ...
        {
            if (KaosesMCMSettings.Instance is { } settings && settings.BalancingTimeRecruitsTweaksEnabled && hero.CurrentSettlement != null && hero.CurrentSettlement.OwnerClan.Kingdom != null)
            {
                float num = 0f;
