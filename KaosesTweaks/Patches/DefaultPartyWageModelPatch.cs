...
namespace KaosesTweaks.Patches
{
    ...
    public class DefaultPartyWageModelPatch
    {
        ...
        public static void Postfix(ref ExplainedNumber __result, MobileParty mobileParty, bool includeDescriptions = false)
        {
            ...
            try
            {
                if (KaosesMCMSettings.Instance is { } settings && settings.PartyWageTweaksEnabled && mobileParty != null)
                {
                ...
                if (KaosesMCMSettings.Instance is { } settings2 && settings2.BalancingWagesTweaksEnabled &&
        ...
        public static bool Prepare() => KaosesMCMSettings.Instance is { } settings && ((settings.PartyWageTweaksEnabled && settings.PartyWageTweaksHarmonyEnabled) || (settings.KingdomBalanceStrengthEnabled && settings.KingdomBalanceStrengthHarmonyEnabled));
