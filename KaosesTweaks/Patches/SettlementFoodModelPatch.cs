...
namespace KaosesTweaks.Patches
{
    ...
    class SettlementFoodModelPatch
    {
        ...
        {
            if (KaosesMCMSettings.Instance is { } settings && settings.SettlementFoodBonusEnabled && !(town is null))
            {
        ...
        static bool Prepare() => KaosesMCMSettings.Instance is { } settings && settings.SettlementFoodBonusEnabled;
    }
}
