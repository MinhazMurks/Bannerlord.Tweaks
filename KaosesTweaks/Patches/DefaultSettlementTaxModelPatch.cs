...
namespace KaosesTweaks.Patches
{
    ...
    class DefaultSettlementTaxModelPatch
    {
        ...
        private static void Postfix(Town town, bool includeDescriptions, ref ExplainedNumber __result)
        {
            ...
            if (KaosesMCMSettings.Instance is { } settings && settings.BalancingTaxTweaksEnabled && town.Settlement.OwnerClan.Kingdom != null)
            {
                float num = 0f;
        ...
        static bool Prepare() => KaosesMCMSettings.Instance is { } settings && settings.KingdomBalanceStrengthEnabled;
    }
    ...
    public class CalculateVillageTaxFromIncomePatch
    {
        ...
        {
            if (KaosesMCMSettings.Instance is { } settings && settings.BalancingTaxTweaksEnabled && village.Settlement.OwnerClan.Kingdom != null)
            {
                float num = 0f;
                if (settings.KingdomBalanceStrengthVanEnabled)
                {
