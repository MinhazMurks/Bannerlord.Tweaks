...
namespace KaosesTweaks.Models
{
    class BTCombatXpModel : DefaultCombatXpModel
    {
        public override void GetXpFromHit(CharacterObject attackerTroop, CharacterObject captain, CharacterObject attackedTroop, PartyBase party, int damage, bool isFatal, MissionTypeEnum missionType, out int xpAmount)
        {
            ...
            {
                if (KaosesMCMSettings.Instance is { } settings && settings.TournamentHeroExperienceMultiplierEnabled)
                {
            ...
            {
                if (KaosesMCMSettings.Instance is { } settings && settings.ArenaHeroExperienceMultiplierEnabled)
                {
                    if (Statics._settings.TournamentDebug)
                    {
            ...
            {
                if (KaosesMCMSettings.Instance is { } settings && settings.TroopBattleExperienceMultiplierEnabled)
                {
            ...
            {
                if (KaosesMCMSettings.Instance is { } settings && settings.TroopBattleSimulationExperienceMultiplierEnabled)
                {
                    if (Statics._settings.XpModifiersDebug)
                    {
