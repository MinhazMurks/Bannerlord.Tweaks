...
namespace KaosesTweaks.Patches
{
    ...
    public class DefaultPartySizeLimitModelPatch
    {
        ...
        {
            if (KaosesMCMSettings.Instance is { } settings && party != null)
            {
        ...
        static bool Prepare() => KaosesMCMSettings.Instance is { } settings && (settings.PartySizeTweakEnabled || settings.KingdomBalanceStrengthEnabled || settings.PlayerCaravanPartySizeTweakEnabled || settings.PartySizeMultipliersEnabled);
    }
    ...
    public class DefaultPrisonerSizeLimitModelPatch
    {
        private static void Postfix(PartyBase party, ref ExplainedNumber __result)
        {
            ...
            {
                if (KaosesMCMSettings.Instance is { } settings && settings.PrisonerSizeTweakEnabled)
                {
        ...
        static bool Prepare() => KaosesMCMSettings.Instance is { } settings && settings.PrisonerSizeTweakEnabled;
    }
}
