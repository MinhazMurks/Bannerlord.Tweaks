...
namespace KaosesTweaks.Patches
{
    ...
    class BTPrisonerRecruitmentCalculationModelPatch
    {
        ...
        {
            if (KaosesMCMSettings.Instance is { } settings && settings.PrisonerConformityTweaksEnabled && !(party.LeaderHero is null))
            {
                float num;
        ...
        static bool Prepare() => KaosesMCMSettings.Instance is { } settings && settings.PrisonerConformityTweaksEnabled;
    }
}
