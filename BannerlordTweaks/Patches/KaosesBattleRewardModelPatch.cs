...
namespace KaosesTweaks.Patches
{
    ...
    class KTBattleRewardsRenownGainPatch
    {
        ...
        {
            if (KaosesMCMSettings.Instance.BattleRewardsRenownGainModifiers)
            {
                ...
                if (party.LeaderHero == Hero.MainHero && KaosesMCMSettings.Instance.BattleRewardShowDebug)
                {
        ...
        static bool Prepare() => KaosesMCMSettings.Instance is { } settings && settings.MCMBattleRewardModifiers && settings.BattleRewardModifiersPatchOnly && settings.BattleRewardsRenownGainModifiers;
    }
    ...
    class KTBattleRewardsInfluenceGainPatch
    {
        ...
        {
            if (KaosesMCMSettings.Instance.BattleRewardsInfluenceGainModifiers)
            {
                //~ KT
        ...
        static bool Prepare() => KaosesMCMSettings.Instance is { } settings && settings.MCMBattleRewardModifiers && settings.BattleRewardModifiersPatchOnly && settings.BattleRewardsInfluenceGainModifiers;
    }
    ...
    class KTBattleRewardsMoraleGainPatch
    {
        private static bool Prefix(PartyBase party, float renownValueOfBattle, float contributionShare, ref ExplainedNumber __result)
        {
            if (KaosesMCMSettings.Instance.BattleRewardsMoraleGainModifiers)
            {
        ...
        static bool Prepare() => KaosesMCMSettings.Instance is { } settings && settings.MCMBattleRewardModifiers && settings.BattleRewardModifiersPatchOnly && settings.BattleRewardsMoraleGainModifiers;
    }
    ...
    class KTBattleRewardsGoldLossPatch
    {
        ...
        {
            if (KaosesMCMSettings.Instance.MCMBattleRewardModifiers && KaosesMCMSettings.Instance.BattleRewardsGoldLossModifiers)
            {
                ...
                if (partyLeaderHero == Hero.MainHero && KaosesMCMSettings.Instance.BattleRewardShowDebug)
                {
        ...
        static bool Prepare() => KaosesMCMSettings.Instance is { } settings && settings.MCMBattleRewardModifiers && settings.BattleRewardModifiersPatchOnly && settings.BattleRewardsGoldLossModifiers;
    }
    ...
    class KTBattleRewardsGainedRelationAmountPatch
    {
        ...
        {
            if (KaosesMCMSettings.Instance.BattleRewardsRelationShipGainModifiers)
            {
        ...
        static bool Prepare() => KaosesMCMSettings.Instance is { } settings && settings.MCMBattleRewardModifiers && settings.BattleRewardModifiersPatchOnly && settings.BattleRewardsRelationShipGainModifiers;
