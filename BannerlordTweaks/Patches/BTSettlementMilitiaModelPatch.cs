...
namespace KaosesTweaks.Patches
{
    ...
    class BTSettlementMilitiaModelPatch
    {
        ...
        {
            if (KaosesMCMSettings.Instance is { } settings && settings.SettlementMilitiaBonusEnabled && !(settlement is null))
            {
        ...
        static bool Prepare() => KaosesMCMSettings.Instance is { } settings && settings.SettlementMilitiaBonusEnabled;
    }
}
