...
namespace KaosesTweaks.Models
{
    class BTWorkshopModel : DefaultWorkshopModel
    {
        ...
        {
            if (KaosesMCMSettings.Instance is { } settings && settings.MaxWorkshopCountTweakEnabled)
        ...
        {
            if (KaosesMCMSettings.Instance is { } settings && settings.WorkshopBuyingCostTweakEnabled && workshop != null)
        ...
        {
            if (KaosesMCMSettings.Instance is { } settings && settings.WorkshopEffectivnessEnabled)
