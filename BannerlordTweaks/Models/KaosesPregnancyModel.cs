...
namespace KaosesTweaks.Models
{
    public class KaosesPregnancyModel : DefaultPregnancyModel
    {
        ...
        public override float GetDailyChanceOfPregnancyForHero(Hero hero)
        {
            ...
            if (KaosesMCMSettings.Instance is { } settings && hero != null)
            {
                ...
                if (hero.Children != null && hero.Children.Any() && hero.Children.Count >= KaosesMCMSettings.Instance.MaxChildren)
                {
                    if (Statics._settings.PregnancyDebug)
                    {
        ...
        private bool IsHeroAgeSuitableForPregnancy(Hero hero)
        {
            ...
            return (double)hero.Age >= KaosesMCMSettings.Instance!.MinPregnancyAge && (double)hero.Age <= KaosesMCMSettings.Instance!.MaxPregnancyAge;
        }
